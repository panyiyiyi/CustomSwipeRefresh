package com.swiperefreshtest.view;
...
//    private static final int CIRCLE_BG_LIGHT = 0xFFFAFAFA;//系统圆圈背景色
    private static final int CIRCLE_BG_LIGHT = 0x00FFFFFF;
    // Default offset in dips from the top of the view to where the progress spinner should stop
    private static final int DEFAULT_CIRCLE_TARGET = 64;

    private View mTarget; // the target of the gesture
    SwipeRefresh.OnRefreshListener mListener;
    ...
    private SwipeRefresh.OnChildScrollUpCallback mChildScrollUpCallback;
    ...
    /**
     * Simple constructor to use when creating a AylsonSwipeRefresh from code.
     *
     * @param context
     */
    ...
    /**
     * Constructor that is called when inflating AylsonSwipeRefresh from XML.
     *
     * @param context
     * @param attrs
     */
     ...
     * gesture.
     */
    public void setOnRefreshListener(SwipeRefresh.OnRefreshListener listener) {
        mListener = listener;
    }
    ...
    /**
     * Set a callback to override {@link SwipeRefresh#canChildScrollUp()} method. Non-null
     * callback will return the value provided by the callback and ignore all internal logic.
     *
     * @param callback Callback that should be called when canChildScrollUp() is called.
     */
    public void setOnChildScrollUpCallback(@Nullable SwipeRefresh.OnChildScrollUpCallback callback) {
    ...
    /**
     * Classes that wish to override {@link SwipeRefresh#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link SwipeRefresh#canChildScrollUp()} method
         * is called to allow the implementer to override its behavior.
         *
         * @param parent AylsonSwipeRefresh that this callback is overriding.
         * @param child  The child view of AylsonSwipeRefresh.
         * @return Whether it is possible for the child view of parent layout to scroll up.
         */
        boolean canChildScrollUp(SwipeRefresh parent, @Nullable View child);
    }
}
