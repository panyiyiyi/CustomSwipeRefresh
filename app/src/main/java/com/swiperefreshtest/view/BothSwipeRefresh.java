...
/**
 * Created by Even on 2017/7/26.
 * Description:可以实现上拉加载下拉刷新的RecyclerView
 */

public class BothSwipeRefresh extends ViewGroup {
     ...
     * @param context
     */
    public BothSwipeRefresh(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public BothSwipeRefresh(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        final TypedArray a2 = context.obtainStyledAttributes(attrs, com.orangegangsters.github.swipyrefreshlayout.library.R.styleable.SwipyRefreshLayout);
        SwipyRefreshLayoutDirection direction
                = SwipyRefreshLayoutDirection.getFromInt(a2.getInt(com.orangegangsters.github.swipyrefreshlayout.library.R.styleable.SwipyRefreshLayout_direction, 0));
